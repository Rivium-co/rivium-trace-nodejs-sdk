...
// Hardcoded API URL - all errors go to RiviumTrace API
// Internal dev override via env var (not documented, not in public API)
const RIVIUMTRACE_API_URL = process.env.RIVIUMTRACE_DEV_API_URL || 'https://trace.rivium.co';
...
class RiviumTraceConfig {
  constructor(options = {}) {
    ...
    this.apiUrl = RIVIUMTRACE_API_URL;
